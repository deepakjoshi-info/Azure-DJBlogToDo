...
using DJBlogToDo.Models;using System.Diagnostics;

namespace DJBlogToDo.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            return View(new Todo { DueDate = DateTime.Now });
        }
        ...
        public ActionResult Create([Bind(Include = "Description,DueDate")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Description,DueDate")] Todo todo)
        {
